...
_NEUTRAL_DEFAULTS = dict(
    ...
    # Tier 3
    kr_yc_spread_bps=60.0, kr_yc_inverted=False, kr_yc_regime="normal",
    ...
    # Tier 4
    equity_bond_corr_60d=-0.4, equity_bond_corr_regime="normal_hedge",
)
...
HISTORICAL_CASES = [
    (
        ...
        _case(
            ...
            equity_bond_corr_60d=0.5, equity_bond_corr_regime="extreme_positive",
        ),
        8.5, 10.0, "risk_off",
    ),
    (
        ...
        _case(
            ...
            equity_bond_corr_60d=0.35, equity_bond_corr_regime="extreme_positive",
        ),
        9.0, 10.0, "risk_off",
    ),
    (
        ...
        _case(
            ...
            equity_bond_corr_60d=-0.45, equity_bond_corr_regime="normal_hedge",
        ),
        0.0, 3.0, "risk_on",
    ),
    (
        ...
        _case(
            ...
            equity_bond_corr_60d=-0.2, equity_bond_corr_regime="weakening_hedge",
        ),
    ...
    (
        ...
        _case(
            ...
            equity_bond_corr_60d=0.40, equity_bond_corr_regime="extreme_positive",
        ),
        7.0, 9.0, "risk_off",
    ),
    (
        ...
        _case(
            ...
            equity_bond_corr_60d=-0.40, equity_bond_corr_regime="normal_hedge",
        ),
        3.0, 5.0, "neutral",
    ),
    (
        ...
        _case(
            ...
            equity_bond_corr_60d=0.15, equity_bond_corr_regime="positive_flip",
        ),
        4.0, 6.5, "neutral",
    ),
    (
        ...
        _case(
            ...
            equity_bond_corr_60d=0.10, equity_bond_corr_regime="positive_flip",
        ),
        6.0, 8.5, "risk_off",
    ),
]
