"""Pre-mock pypfopt/cvxpy for integration tests.
...
which poisons sys.modules['tradingagents.agents'] and prevents any integration
test from running. This conftest pre-injects a MagicMock shim before collection
so the import chain succeeds — mirroring tests/unit/agents/conftest.py.
"""
import sys
