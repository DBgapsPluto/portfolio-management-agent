...
def test_historical_mode_drops_news_components() -> None:
    ...
    # Perturb several news fields significantly.
    state_perturbed["news_report"].news_sentiment.sentiment_dispersion = 1.5
    # geopolitical count_change_vs_7d
    state_perturbed["news_report"].news_sentiment.count_change_vs_7d["geopolitical"] = 3.0
    # surprise_index_30d
    ...
    diff_found = any(
        ...
        for f in ("growth_surprise", "inflation_surprise", "equity_vol_regime",
                  "term_premium", "credit_cycle", "liquidity_regime")
    )
